...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch("https://formspree.io/f/xzzvjnor", {
        method: "POST",
        headers: {
  ...
  return (
    <section id="contact" className="relative z-10 px-4 py-20 lg:px-8">
      <div className="mx-auto max-w-4xl">
        ...
        >
          ...
          <h3 className="font-clash mb-8 text-4xl font-bold lg:text-5xl">
            Get In Touch
          </h3>
        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:gap-12">
          ...
          >
            ...
            <div className="text-center">
              <a
                href="https://drive.google.com/file/d/1SJfFbm3K0sUf7sVyJsZeRnyy2YHqZMri/view?usp=sharing"
